...
export default function Home() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/tickets")
      .then(response => {
        console.log("📢 Datos recibidos desde API:", response.data); // Verifica los datos
        setTodosLosViajes(response.data);
  
        // Obtener los valores únicos de origen y destino
        ...
        console.log("✅ Orígenes disponibles:", origenes); // Verifica los orígenes en consola
