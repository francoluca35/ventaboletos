  ...
  return (
    <div>
      ...
      <div className="fixed top-0 left-0 w-full bg-gray-400 text-black shadow-md flex justify-between items-center p-4 z-50">
        <div className="flex items-center">
          ...
          <button
            ...
            className="text-white bg-red-600 p-3 rounded-full mr-4"
          >
            {isOpen ? <FaTimes size={24} /> : <FaBars size={24} />}
          </button>
          <span className="text-lg font-bold text-right">{formatDate(time)}, {formatTime(time)} PM</span>
        </div>
      ...
      >
        ...
        <ul className="mt-20 space-y-4"> {/* Espaciado para evitar solapamiento con el header */}
